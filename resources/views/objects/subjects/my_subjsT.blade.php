    ...
    <section class="section py-4">
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <img src="{{ asset('icons/user.svg') }}"
                                                 ...
                                                 alt="Вместимость">
                                            <span class="small">{{ $value['capacity_to'] }} мест</span>
                                        </div>
                                        ...
                                        @if(!empty($value['minimum_cost']))
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('icons/ruble.svg') }}"
                                                     class="me-2" style="width: 16px; height: 16px;"
                                                     alt="Рубль">
                                                <span class="small">От {{ $value['minimum_cost'] }} ₽</span>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="mt-auto">
                                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                            ...
                                            <div class="actions d-flex align-items-center gap-3">
                                                <a title="Редактировать" class="text-decoration-none text-muted"
                                                   href="{{ route('edit.subj', ['id' => $value['id']]) }}">
                                                    <img src="{{ asset('icons/edit.svg') }}"
                                                         style="width: 18px; height: 18px;"
                                                         alt="Редактировать">
                                                </a>
                                                <a title="Смотреть субъект" class="text-decoration-none text-muted"
                ...
                @else
                    <div class="col-12">
                        <p class="text-center text-muted fs-5">К сожалению, у вас пока нет объектов...</p>
                    </div>
                @endif
